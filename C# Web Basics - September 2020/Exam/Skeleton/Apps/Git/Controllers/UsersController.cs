...
namespace Git.Controllers
{
    public class UsersController : Controller
    {
        ...
        public HttpResponse Register(RegisterInputModel input)
        {
            ...
            {
                return this.Error("Username is required. Username must be between 5 and 20 symbols!");
            }
            ...
            {
                return this.Error("Password is required. Password must be between 6 and 20 symbols!");
            }
